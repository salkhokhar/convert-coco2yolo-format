...
class COCO2YOLO:
    def __init__(self):
        ...
        # specify your specific category of objects that you want
        # if you are using all categories then comment out the self.specific_categories variable
        self.specific_categories = ["bicycle", "motorcycle", "bus", "truck", "car", "train", "stop sign", "traffic light", "fire hydrant", "parking meter"]
        ...
        for k, v in anno_dict.items():
            ...
            with open(os.path.join(output, file_name), 'w', encoding='utf-8') as f:
                ...
                for obj in v:
                    ...
                    # if you have commented out self.specific_categories variable then
                    # comment out the if condition and replace the category_id variable with
                    # category_id = self.coco_name_list.index(cat_name)
                    if cat_name in self.specific_categories:
                        
                    
                        category_id = self.specific_categories.index(cat_name)
